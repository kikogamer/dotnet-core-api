...
namespace DEVIO.Api.Extensions
{
    public class JsonWithFilesFormDataModelBinder : IModelBinder
    {
        ...
        private readonly FormFileModelBinder _formFileModeBinder;

        public JsonWithFilesFormDataModelBinder(IOptions<MvcJsonOptions> jsonOptions, ILoggerFactory loggerFactory)
        {
            _jsonOptions = jsonOptions;
            _formFileModeBinder = new FormFileModelBinder(loggerFactory);
        }
        ...
        public async Task BindModelAsync(ModelBindingContext bindingContext)
        {
            ...
            foreach (var property in bindingContext.ModelMetadata.Properties)
            {
                ...
                {
                    await _formFileModeBinder.BindModelAsync(bindingContext);
